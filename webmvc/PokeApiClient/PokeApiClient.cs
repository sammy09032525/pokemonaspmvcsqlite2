...
//            using var sr = new System.IO.StreamReader(stream);
            return JsonSerializer.Deserialize<T>(str, new JsonSerializerOptions());// { PropertyNamingPolicy = JsonNamingPolicy.SnakeCaseLower });
        }
        ...
        {
            using var sr = new System.IO.StreamReader(stream);
            return JsonSerializer.Deserialize<T>(stream, new JsonSerializerOptions { PropertyNamingPolicy= JsonNamingPolicy.CamelCase });// { PropertyNamingPolicy = JsonNamingPolicy.SnakeCaseLower });
        }
